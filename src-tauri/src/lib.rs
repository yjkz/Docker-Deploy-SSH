...
pub fn run() {
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      commands::check_project_sources,
      commands::bind_project_source,
      commands::update_project_from_source,
      ...
      commands::rollback_set_release_notes,
    ...
    .setup(|app| {
      ...
      // 部署日报(第二十八批 B2):按设置启停(缺省关)
      crate::digest::sync_from_settings(app.handle());
