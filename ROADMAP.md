...
- 版本 **v6.10.0**;main = origin/main;基线 `cargo test` **461 passed** / 13 ignored
- 命令 **113** 个(generate_handler 实测;第二十二批 +3 调度 +2 配置历史;第二十五批 +5 导入/清理/compose)
- **第二十八批(2026-09-19)已完成**:候选池余项四项(部署窗口 / 部署日报 / 多项目编排 / 传输中可取消)——**候选池就此清空**;测试 444→461,命令 113 不变
