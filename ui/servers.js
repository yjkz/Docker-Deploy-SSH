...
(function () {
  ...
  window.ServersKit = { st: st, el: el, renderServers: renderServers, setLogOpen: setLogOpen };
  var openCleanupModal = function () { return window.ServersCleanup.openCleanupModal.apply(null, arguments); };
  var closeCleanupModal = function () { return window.ServersCleanup.closeCleanupModal.apply(null, arguments); };
  var cleanupModal = function () { return window.ServersCleanup.cleanupModal.apply(null, arguments); };
})();
