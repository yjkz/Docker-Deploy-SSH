  ...
  var CHAPTERS = [
    ...
    },
    {
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>回滚预检</strong>:在回滚确认页点「回滚预检」会核对每个服务在该归档里的镜像来源 —— 归档内有包(直接装载)/ 服务器上仍持有该镜像 ID(智能传输跳过的服务,直接可用)/ <strong>回不去</strong>(镜像已被覆盖或清理)。有「回不去」的服务时会逐条列出并让您确认,不会静默跳过;确认后其余服务照常回退,这些服务沿用服务器当前镜像。</li>
    ...
    },
    {
      ...
      html: `
        ...
        服务器上,回滚直接可用)/ <strong>回不去</strong>(镜像已被覆盖或清理)。有「回不去」的服务时会逐条
