    ...
    },
    {
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>批量部署</strong>(页首「批量部署」按钮):勾选多台服务器后按队列<strong>串行</strong>执行当前模式(单镜像 / 整栈)的完整部署,每台独立环境预检、独立写历史(可逐台回滚);面板实时显示每台状态,点「停止批量」后当前台跑完即停止,余下标记「已跳过」;中途取消当前台同样会停止批量。</li>
        </ul>
