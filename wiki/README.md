...
| [04-契约参考.md](04-契约参考.md) | **92 个命令 + 12 个事件 + 配置 JSON Schema 完整速查** | 跨前后端改动的对账表 |
...
测试:cargo test(纯函数单测 269 passed;真机测试 #[ignore] 13 个)
当前版本:v5.8.1(tauri.conf.json / Cargo.toml;第八批:检查更新后弹更新确认模态——展示更新内容、一次确认全自动更新,含第七批回滚中心提速与版本说明)
```
